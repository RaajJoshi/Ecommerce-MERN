...
const MyProducts = () => {
  ...
  const { error, products } = useSelector((state) => state.myProducts);
  ...
  return (
    <Fragment>
      <MetaData title={`${customer.name}'s Products`} />

      <div>
        <div className="productListContainer">
          <h1 id="productListHeading">YOUR PRODUCTS</h1>
