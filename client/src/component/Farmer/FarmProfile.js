...
import { loadFarmer, updateFarmProfile, clearErrors } from '../../actions/userActions';
import { UPDATE_FARMER_RESET } from '../../constants/uaerConstants';
...
const FarmProfile = () => {
  ...
  const updateProfileSubmit = (e) => {
    ...
    dispatch(updateFarmProfile(cname, email, phoneno, city, avatar));
  };
  ...
  const passwordUpdateHandler = (e) => {
    navigate('/farmProfile/updatePasswd');
  }
