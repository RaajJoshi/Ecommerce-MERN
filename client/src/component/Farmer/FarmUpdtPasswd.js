...
import "../../Customer/UpdatePassword.css";
import * as AiIcons from "react-icons/ai";
import Loader from "../../component/Loader";
import { useDispatch, useSelector } from "react-redux";
import { clearErrors, updateFarmPassword } from "../../actions/userActions";
import { useAlert } from "react-alert";
import { UPDATE_FARMPASSWD_RESET } from "../../constants/uaerConstants";
...
const FarmUpdtPasswd = () => {
  ...
  const updatePasswordSubmit = (e) => {
    ...
    dispatch(updateFarmPassword(myForm));
  };
