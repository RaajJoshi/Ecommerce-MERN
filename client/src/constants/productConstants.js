...
export const OWN_PRODUCTS_REQUEST = "OWN_PRODUCTS_REQUEST";
export const OWN_PRODUCTS_SUCCESS = "OWN_PRODUCTS_SUCCESS";
export const OWN_PRODUCTS_FAIL = "OWN_PRODUCTS_FAIL";
